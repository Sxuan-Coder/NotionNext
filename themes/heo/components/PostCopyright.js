...
export default function PostCopyright({ post }) {
  ...
  return (
    <section className='dark:text-[var(--heo-text-2)] mt-6 mx-1 '>
      <ul className='overflow-x-auto whitespace-nowrap text-sm dark:bg-gray-900 bg-gray-100 p-5 leading-8 border-l-2 border-[var(--heo-main)]'>
        <li>
