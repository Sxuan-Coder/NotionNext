              ...
              return (
                    ...
                    >
                        <div className={`${className || ''} 
                            ${selected ? 'text-white bg-[var(--heo-main)] dark:bg-yellow-600' : ''}
                            flex items-center hover:bg-[var(--heo-main)] dark:hover:bg-yellow-600 hover:scale-110 hover:text-white rounded-lg px-2 py-0.5 duration-150 transition-all`}
                        >
