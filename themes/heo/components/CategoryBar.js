  ...
  return (
    <div
      ...
      className={`wow fadeInUp flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full lg:bg-white dark:lg:bg-[#1e1e1e]  
            ${border ? 'lg:border lg:hover:border border-[var(--heo-card-border)] dark:lg:border-white/10 hover:border-[var(--heo-main)] dark:hover:border-yellow-600 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
      <div
      ...
      <div id='category-bar-next' className='flex items-center justify-center'>
        <div
          id='right'
          className='cursor-pointer mx-2 dark:text-[var(--heo-text-2)] dark:hover:text-yellow-600 hover:text-[var(--heo-main)]'
        ...
        <SmartLink
          href='/category'
          className='whitespace-nowrap font-bold text-[var(--heo-text)] dark:text-white transition-colors duration-200 hover:text-[var(--heo-main)] dark:hover:text-yellow-600'>
...
const MenuItem = ({ href, name }) => {
  ...
  return (
    <div
      className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-[var(--heo-text)] dark:text-white hover:text-white hover:bg-[var(--heo-main)] dark:hover:bg-yellow-600 ${selected ? 'text-white bg-[var(--heo-main)] dark:bg-yellow-600' : ''}`}>
